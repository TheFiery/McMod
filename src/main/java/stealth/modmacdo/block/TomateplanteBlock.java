...
package stealth.modmacdo.block;

import stealth.modmacdo.procedures.TomateplanteMiseAJourDuTickProcedure;
import stealth.modmacdo.item.TomateItem;
...
public class TomateplanteBlock extends ModmacdoModElements.ModElement {
	@ObjectHolder("modmacdo:tomateplante")
	public static final Block block = null;
	public TomateplanteBlock(ModmacdoModElements instance) {
		super(instance, 10);
	}
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement().sound(SoundType.CROP).hardnessAndResistance(0.1f, 1f)
					.lightValue(0));
			setRegistryName("tomateplante");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TomateItem.block, (int) (1)));
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				TomateplanteMiseAJourDuTickProcedure.executeProcedure($_dependencies);
			}
