...
public class SaladeplanteBlock extends ModmacdoModElements.ModElement {
	@ObjectHolder("modmacdo:saladeplante")
	public static final Block block = null;
	public SaladeplanteBlock(ModmacdoModElements instance) {
		super(instance, 15);
	}
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement().sound(SoundType.PLANT).hardnessAndResistance(0f, 1f)
					.lightValue(0));
			setRegistryName("saladeplante");
		}
