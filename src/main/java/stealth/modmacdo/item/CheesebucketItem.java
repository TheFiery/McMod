...
public class CheesebucketItem extends ModmacdoModElements.ModElement {
	@ObjectHolder("modmacdo:cheesebucket")
	public static final Item block = null;
	public CheesebucketItem(ModmacdoModElements instance) {
		super(instance, 21);
	}
